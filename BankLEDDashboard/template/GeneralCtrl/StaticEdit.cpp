...
{	
	...
	SetFont(m_csFontName,(_stParam.nHeight - 4));
...
{
	this->m_pDataEdit->GetLine(0,szEdit);
}
...
#ifdef _UNICODE
	wcscpy((LPTSTR)lf.lfFaceName, _T("Arial"));     // request a face name 
#else
	strcpy((LPTSTR)lf.lfFaceName, _T("Arial"));     // request a face name 
#endif
	CFont font;
	font.DeleteObject();
