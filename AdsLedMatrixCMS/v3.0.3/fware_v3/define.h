...
#define     SMALL_SIZE          80*EEPROM_PAGE

#define     BASE_LINE_5         START_RAM+1*SMALL_SIZE
#define     BASE_LINE_6         START_RAM+2*SMALL_SIZE
#define     BASE_LINE_7         START_RAM+3*SMALL_SIZE
#define     BASE_LINE_8         START_RAM+4*SMALL_SIZE

#define     START_RAM_BK        START_RAM   
#define     START_RAM_TEXT      (START_RAM_BK)   
