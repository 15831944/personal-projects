...
protected:
	...
	HICON m_hIcon;
	int	m_ColorText[MAX_LINE][4];	
	BOOL m_GradientText[MAX_LINE][4];
	CString m_csTextLayer[MAX_LINE][4];
	CString m_csFontTextLayer[MAX_LINE][4];
	...
	afx_msg void OnCloseupComboLineIndex();
