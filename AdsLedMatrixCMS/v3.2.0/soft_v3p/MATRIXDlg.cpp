...
BOOL CMATRIXDlg::OnInitDialog()
{
	...
	CString csWindowText = _T("LCMS\x0AE"L" v3.05 - ");
	csWindowText += __SETTING.m_csLicense;
	this->SetWindowText(csWindowText+_T(" www.ic-vn.com"));

	CComboBox* pCombo = (CComboBox*)GetDlgItem(IDC_COMBO_SCROLL_MODE);	
	pCombo->AddString(_T("Tr\xE1"L"i - D\x1EEB"L"ng"));	
	...
	pCombo->AddString(_T("Ch\x1EA1"L"y Th\x1EB3"L"ng"));
