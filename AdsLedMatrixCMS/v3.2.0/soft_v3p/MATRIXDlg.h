...
protected:
	...
	HICON m_hIcon;
	int	m_ColorText[MAX_LINE][LAYER_COUNT];	
	BOOL m_GradientText[MAX_LINE][LAYER_COUNT];
	CString m_csTextLayer[MAX_LINE][LAYER_COUNT];
	CString m_csFontTextLayer[MAX_LINE][LAYER_COUNT];
