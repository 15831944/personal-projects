  ...
  if (tick_count > scroll_rate){    
    ...
    case 0:                
        if (is_stopping==0){   
   	    ...
   	    if (start_mem == (0x500        + 128*4)    + (128<<2))
   	        is_stopping = 1;
   	    if (is_stopping ==1)
   	    {
       	...
       	if (start_mem > (0x500        + 128*4)    +4*(text_length+128+32))             
   	    {                  
    ...
    case 3:               
        if (scroll_count >=0){        
            ...
            scroll_count = 16            <<1;
            start_mem += 4*128;                                  
            if (start_mem >= ((0x500        + 128*4)    +4*(text_length+128))){
                LoadFrame(++frame_index);
            }  
        }
        if (is_stopping==1)
...
{                             
    ...
    length = (unsigned int)address+4*(128+length);         
    if (length%64   )
...
{                 
    ...
    LoadToRAM((unsigned char     *   )(0x500        + 128*4)   ,text_length,index);
    stopping_count = 0;
    scroll_count = 0;
    is_stopping = 0;
    switch (scroll_type)
    {
    case 0:
        start_mem = (unsigned char     *   )(0x500        + 128*4)   ; 
        break;                
    case 1:
        start_mem = (unsigned char     *   )(0x500        + 128*4)    + (text_length<<2); 
        break;
    case 3:                             
        scroll_count = 16            <<1;
        start_mem = (unsigned char     *   )(0x500        + 128*4)    + (128<<2); 
        break;
    case 2:   
        scroll_count = 0;                     
        start_mem = (unsigned char     *   )(0x500        + 128*4)    + (128<<2); 
...
void ProcessCommand()
{
    ...
    case 2 :
        {                
            ...
            BlankRAM((unsigned char     *   )0x500    ,(unsigned char     *   )0x8000);
            SerialToRAM((unsigned char     *   )(0x500        + 128*4)   +4*(128),text_length);                
			start_mem = (unsigned char     *   )(0x500        + 128*4)   +4*(128);				
			SaveToEEPROM((unsigned char     *   )(0x500        + 128*4)   ,text_length,rx_lparam);
    ...
    case 10:
        {
            ...
            LoadToRAM((unsigned char     *   )(0x500        + 128*4)   ,text_length,rx_lparam); 
            start_mem = (unsigned char     *   )(0x500        + 128*4)   +4*(128);
        }
        break;  
    case 16  :
