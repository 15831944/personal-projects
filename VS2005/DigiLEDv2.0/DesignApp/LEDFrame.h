...
// Attributes
public:
	ARRAY_LEDPAGEEDIT m_arrLEDEdit;
	ARRAY_MATRIXPAGEEDIT m_arrMatrixEdit;
	ARRAY_STATICPAGEEDIT m_arrStaticEdit;
// Operations
public:
...
public:
	...
	void AddControl();
	BOOL IsPageEnable(UINT nID);
	BOOL RemoveLED(CLEDPageEdit* pLED);
	BOOL RemoveMatrix(CMatrixPageEdit* pMatrix);
	BOOL RemoveStatic(CStaticPageEdit* pStatic);
