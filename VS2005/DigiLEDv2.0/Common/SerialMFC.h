...
public:
	...
	virtual LONG Open (LPCTSTR lpszDevice, HWND hwndDest, DWORD idThread, UINT nComMsg = WM_NULL, LPARAM lParam = 0, DWORD dwInQueue = 0, DWORD dwOutQueue = 0)
	{ 
		return CSerialWnd::Open(lpszDevice,hwndDest,idThread,nComMsg,lParam,dwInQueue,dwOutQueue); 
	}
};
