...
#asm
   ...
   .equ __scl_bit=2
#endasm                   
unsigned char      eeprom_read(unsigned char      deviceID, unsigned char     *    address) 
{
    unsigned char      data;
    i2c_start();
    i2c_write(deviceID);        // issued R/W = 0
    i2c_write((unsigned int)address>>8);      // high word address
    i2c_write((unsigned int)address&0x0FF);   // low word address
...
void eeprom_write(unsigned char      deviceID, unsigned char     *    address, unsigned char      data) 
{
    i2c_start();
...
unsigned int eeprom_read_w(unsigned char      deviceID, unsigned char     *    address)
{
...
void eeprom_write_w(unsigned char      deviceID, unsigned char     *    address, unsigned int data)
{
    eeprom_write(deviceID,address,data>>8);
    eeprom_write(deviceID,address+1,data&0x0FF);    
}
void eeprom_read_page(unsigned char      deviceID, unsigned char     *    address, unsigned char     *    buffer, unsigned char      page_size)
{
    unsigned char      i = 0;
    i2c_start();
    i2c_write(deviceID);            // issued R/W = 0
    i2c_write((unsigned int)address>>8);          // high word address
    i2c_write((unsigned int)address&0xFF);        // low word address
...
void eeprom_write_page(unsigned char      deviceID, unsigned char     *    address, unsigned char     *    buffer, unsigned char      page_size)
{
    unsigned char      i = 0;
    i2c_start();
    i2c_write(deviceID);            // issued R/W = 0
