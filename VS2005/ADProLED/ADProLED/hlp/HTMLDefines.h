...
#define HID_ZOOM_RTIME                          0x10065
#define HID_ZOOM_PREV                           0x10066
#define HID_ZOOM_WINDOW                         0x10067
#define HID_ZOOM_EXT                            0x10068
#define HID_ZOOM_IN                             0x10069
#define HID_ZOOM_OUT                            0x1006A
#define HID_PAN_RTIME                           0x1006B
#define HID_PAN_POINT                           0x1006C
#define HID_3DVIEWS_TOP                         0x1006D
#define HID_3DVIEWS_BOTTOM                      0x1006E
#define HID_3DVIEWS_LEFT                        0x1006F
#define HID_3DVIEWS_RIGHT                       0x10070
#define HID_3DVIEWS_FRONT                       0x10071
#define HID_3DVIEWS_BACK                        0x10072
#define HID_3DVIEWS_SWISOMETRIC                 0x10073
#define HID_3DVIEWS_SEISOMETRIC                 0x10074
#define HID_3DVIEWS_NEISOMETRIC                 0x10075
#define HID_3DVIEWS_NWISOMETRIC                 0x10076
#define HID_3DVIEWS_VIEWPOINTPRESETS            0x10077
#define HID_FILE_PRINTPREVIEW                   0x18003
#define HID_FILE_RECENT                         0x18004
#define HID_PREVIEW_EXIT                        0x18008
#define HID_PREVIEW_PRINT                       0x18009
#define HID_FMT_LINEWEIGHT                      0x1800A
#define HID_FMT_TEXTSTYLE                       0x1800B
#define HID_TOOL_DISTANCE                       0x1800C
#define HID_TOOL_AREA                           0x1800D
#define HID_TOOL_OPTIONS                        0x1800E
#define HID_FMT_PAGE                            0x1800F
#define HID_FMT_LAYER                           0x18011
#define HID_FMT_LINETYPE                        0x18012
#define HID_TOOL_CALIBRATE                      0x18013
#define HID_TOOL_DWGINFO                        0x18014
#define HID_TOOL_CMDLINE                        0x18016
#define HID_DRAW_LINE                           0x18017
#define HID_DRAW_HATCH                          0x18018
#define HID_EDIT_MOVE                           0x1801B
#define HID_DRAW_CIRC_CR                        0x1801D
#define HID_EDIT_ROTATE                         0x1801E
#define HID_EDIT_ERASE                          0x1801F
#define HID_EDIT_PROP                           0x18020
#define HID_EDIT_SCALE                          0x18022
#define HID_EDIT_MIRROR                         0x18023
#define HID_EDIT_EXPLODE                        0x18024
#define HID_EDIT_JOIN                           0x18025
#define HID_DRAW_RAY                            0x18026
#define HID_EDIT_XLINE                          0x18027
#define HID_DRAW_MLINE                          0x18028
#define HID_DRAW_CIRC_CD                        0x18029
#define HID_DRAW_CIRC_2P                        0x1802A
#define HID_DRAW_CIRC_3P                        0x1802B
#define HID_DRAW_ARC_3P                         0x1802C
#define HID_DRAW_ARC_SCE                        0x1802E
#define HID_DRAW_ARC_SCA                        0x1802F
#define HID_DRAW_ARC_SCL                        0x18030
#define HID_DRAW_ARC_SEA                        0x18031
#define HID_DRAW_ARC_SED                        0x18032
#define HID_DRAW_ARC_SER                        0x18033
#define HID_DRAW_ARC_CSE                        0x18034
#define HID_DRAW_ARC_CSA                        0x18035
#define HID_DRAW_ARC_CSL                        0x18036
#define HID_DRAW_ARC_CONTINUE                   0x18037
#define HID_DRAW_ELLIPSE_CENTER                 0x18038
#define HID_DRAW_ELLIPSE_AXIS                   0x18039
#define HID_DRAW_ELLIPSE_ARC                    0x1803A
#define HID_DRAW_PLINE                          0x1803B
#define HID_DRAW_POLYGON                        0x1803C
#define HID_DRAW_POLYLINE                       0x1803D
#define HID_DRAW_RECT                           0x1803E
#define HID_DRAW_SPLINE                         0x1803F
#define HID_DRAW_MAKEBLOCK                      0x18040
#define HID_DRAW_POINT                          0x18041
#define HID_DRAW_MPOINT                         0x18042
#define HID_DRAW_POINT_SINGLE                   0x18043
#define HID_DRAW_POINT_MULTIPLE                 0x18044
#define HID_DRAW_POINT_DIV                      0x18045
#define HID_DRAW_POINT_DIVIDE                   0x18046
#define HID_DRAW_POINT_MEASURE                  0x18047
#define HID_DRAW_SINGLETEXT                     0x18048
#define HID_DRAW_TEXT                           0x18049
#define HID_INS_BLOCK                           0x1804A
#define HID_INS_EXTERNAL                        0x1804B
#define HID_INS_IMAGE                           0x1804C
#define HID_EDIT_UNSELECT                       0x1804D
#define HID_DRAW_MULTI_TEXT                     0x18050
#define HID_FMT_COLOR                           0x18051
#define HID_REPEAT_LAST                         0x18052
#define HID_TOOL_AIDS                           0x18053
#define HID_SHOW_GRID                           0x18054
#define HID_SNAP_GRID                           0x18055
#define HID_DRAW_ELLIPSE                        0x18056
#define HID_PLINE_ENTER                         0x18057
#define HID_PLINE_CANCEL                        0x18058
#define HID_PLINE_ENTER_PGON                    0x1805A
#define HID_PLINE_UNDO                          0x1805B
#define HID_PLINE_ARC                           0x1805C
#define HID_PLINE_LINE                          0x1805D
#define HID_PLINE_INSVER                        0x1805E
#define HID_PLINE_DELVER                        0x1805F
#define HID_PLINE_BULGE                         0x18060
#define HID_SPLINE_ENTER                        0x18062
#define HID_SPLINE_ENTER_CLOSED                 0x18063
#define HID_SPLINE_ENTER_PGON                   0x18064
#define HID_SPLINE_CANCEL                       0x18065
#define HID_SPLINE_UNDO                         0x18066
#define HID_INS_IMAGE_MANAGER                   0x18067
#define HID_IMPORT_SHP                          0x1806B
#define HID_EXPORT_AVSHP                        0x1806C
#define HID_IMPORT_AVSHP                        0x1806D
#define HID_INS_RASTER_IMG                      0x1806F
#define HID_TOOL_SFP                            0x18070
#define HID_TOOL_AVSHP_LAT                      0x18071
#define HID_TOOL_AVSHP_LONG                     0x18072
#define HID_TOOL_AVSHP_GEN                      0x18073
#define HID_TOOL_AVSHP_INSERT                   0x18074
#define HID_FMT_PNTSTYLE                        0x18075
#define HID_TOOL_CONVERT                        0x18076
#define HID_TOOL_INSERT_AVSHP                   0x18077
#define HID_TOOL_CONVERT_TTF_TO_VCF             0x18078
#define HID_TOOL_CONVERY_SHX_TO_VCF             0x18079
#define HID_TOOL_INSTALLED_FONT                 0x1807A
#define HID_TOOL_MAKE_RASTER                    0x1807B
#define HID_TOOL_DRAW_INFO                      0x1807C
#define HID_TOOL_CONVERT_COORDINATE             0x1807D
#define HID_TOOL_OPTION                         0x1807E
#define HID_ZOOM_SEL                            0x1807F
#define HID_LAYERS_ORDER                        0x18080
#define HID_TOOL_VIEW_SETTING                   0x18081
#define HID_PLINE_EDITVER                       0x18082
#define HID_DRAW_XLINE                          0x18083
#define HID_FMT_MLINESTYLE                      0x18084
#define HID_MLINE_ENTER                         0x18085
#define HID_MLINE_ENTER_CLOSED                  0x18086
#define HID_MLINE_CANCEL                        0x18087
#define HID_MLINE_UNDO                          0x18088
#define HID_SELECT_BY_ID                        0x18089
#define HID_SELECT_BY_USERDATA                  0x1808A
#define HID_TOOL_RASTERIZE                      0x1808B
#define HID_SELECT_BY_TEXT                      0x1808C
#define HID_SELECT_BY_POINT                     0x1808D
#define HID_SELECT_BY_RECTANGLE                 0x1808E
#define HID_INS_XREF_MANAGER                    0x1808F
#define HID_IMAGE_MANAGER                       0x18090
#define HID_INS_ARCVIEW                         0x18091
#define HID_SELECT_BY_POLYGON                   0x18092
#define HID_SELECT_BY_POLYLINE                  0x18093
#define HID_SELECT_BY_DISTANCE                  0x18094
#define HID_EDIT_DELETE                         0x18095
#define HID_EDIT_JOINT                          0x18096
#define HID_VIEW_PAGE                           0x18097
#define HID_FORMAT_XREF_MAN                     0x18098
#define HID_TOOL_TTF2VCF                        0x18099
#define HID_TOOL_SHX2VCF                        0x1809A
#define HID_TOOL_FONTLIST                       0x1809B
#define HID_FORMAT_ATT_MAN                      0x1809C
#define HID_FORMAT_IMAGE_MAN                    0x1809D
#define HID_SNAP_DLG                            0x1809E
#define HID_SNAP_CLEAR                          0x1809F
#define HID_FORMAT_PAGE                         0x180A0
#define HID_SNAP_ENDPOINT                       0x180A2
#define HID_SNAP_MIDPOINT                       0x180A3
#define HID_SNAP_CENTER                         0x180A4
#define HID_SNAP_POINT                          0x180A5
#define HID_SNAP_INTER                          0x180A6
#define HID_SNAP_PERPEND                        0x180A7
#define HID_SNAP_TANGENT                        0x180A8
#define HID_SNAP_NEAR                           0x180A9
#define HID_SNAP_GRIP                           0x180AA
#define HID_TOOL_GRID                           0x180AD
#define HID_TOOL_POLAR                          0x180AE
#define HID_SNAP_NONE                           0x180AF
#define HID_TOOL_SET_PAYMENT                    0x180AF
#define HID_VIEW_BLOCK                          0x180B0
#define HID_FMT_DIMSTYLE                        0x180B1
#define HID_DESIGN_EXPORT2PCB                   0x180B2
#define HID_EXPORTTO_PROTELPCB2                 0x180B3
#define HID_DIM_LINEAR                          0x180B5
#define HID_DIM_ALIGNED                         0x180B6
#define HID_DIM_ORDINATE                        0x180B7
#define HID_DIM_RADIUS                          0x180B8
#define HID_DIM_DIAM                            0x180B9
#define HID_DIM_ANGULAR                         0x180BA
#define HID_DIM_LEADER                          0x180BB
#define HID_DIM_CMARK                           0x180BC
#define HID_EDIT_TRIM                           0x180BD
#define HID_EDIT_EXTEND                         0x180BE
#define HID_VIEW_MAG                            0x180C0
#define HID_VIEW_AVIEW                          0x180C1
#define HID_BREAK_INTO                          0x180C2
#define HID_INS_ATTDEF                          0x180C3
#define HID_EDIT_ATTRIB                         0x180C4
#define HID_FMT_ATTMAN                          0x180C5
#define HID_TOOL_AREAIP                         0x180C6
...
#define HIDR_ADPROLEDTYPE                       0x20081
#define HIDR_DRAW                               0x20086
#define HIDR_EDIT                               0x20088
#define HIDR_SNAP                               0x2008E
 
// Dialogs (IDD_*) 
#define HIDD_ABOUTBOX                           0x20064
#define HIDD_LOGIN                              0x20082
#define HIDD_LEDTEXT_DLG                        0x2008D
#define HIDD_NODETEXT_DLG                       0x2008D
#define HIDD_CALC_DLG                           0x20095
#define HIDD_SET_PAYMENT_DLG                    0x20096
