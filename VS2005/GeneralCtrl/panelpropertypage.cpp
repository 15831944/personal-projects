...
#ifdef _UNICODE
	swscanf_s(szBuffer,_T("%d"),&((CParamsStruct*)GetParams())->nDigits);	
#else
	sscanf_s(szBuffer,_T("%d"),&((CParamsStruct*)GetParams())->nDigits);	
#endif
...
#ifdef _UNICODE
	swscanf_s(szBuffer,_T("%d"),&((CParamsStruct*)GetParams())->nHeight);	
#else
	sscanf_s(szBuffer,_T("%d"),&((CParamsStruct*)GetParams())->nHeight);	
#endif
...
BOOL CPanelPropertyPageGeneral::OnSetActive() 
{
	...
	for (int i=0; i< sizeof(__TABLE_COLOR_OFF); i++){
		if (((CParamsStruct*)GetParams())->clrSegOff == __TABLE_COLOR_OFF[i]){
			index =i;
			break;
		}
	}
	if (index < sizeof(__TABLE_COLOR_OFF)){
		m_nColorSegOff = index;
	}
...
#ifdef _UNICODE
	swscanf_s(szBuffer,_T("%d"),&((CParamsStruct*)GetParams())->nWidth);	
#else
	sscanf_s(szBuffer,_T("%d"),&((CParamsStruct*)GetParams())->nWidth);	
#endif
...
#ifdef _UNICODE
	swscanf_s(szBuffer,_T("%d"),&((CParamsStruct*)GetParams())->nTopMargin);	
#else
	sscanf_s(szBuffer,_T("%d"),&((CParamsStruct*)GetParams())->nTopMargin);	
#endif
...
#ifdef _UNICODE
	swscanf_s(szBuffer,_T("%d"),&((CParamsStruct*)GetParams())->nLeftMargin);	
#else
	sscanf_s(szBuffer,_T("%d"),&((CParamsStruct*)GetParams())->nLeftMargin);	
#endif
